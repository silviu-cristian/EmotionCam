...
it is designed for one person using a built-in laptop webcam. Version 1.1.2 adds
...
Choose **v1.1.2-ai AI-enabled** if you want the same local app plus optional
...
```text
emotioncam\release\EmotionCam_Setup_v1.1.2_AI.exe
```

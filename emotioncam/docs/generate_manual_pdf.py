...
story = [
    ...
    Paragraph("Local-first visible-expression estimates with optional Local Ollama or OpenAI AI analysis", styles["CoverSub"]),
    Paragraph("Version 1.2.0 AI-enabled | Updated June 16, 2026", styles["CoverSub"]),
    PageBreak(),
]
